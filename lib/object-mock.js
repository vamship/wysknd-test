...
class Stub {
    ...
    constructor(instance, methodName, returnValue, create, isAsync) {
        ...
        this._stub = _sinon.stub(instance, methodName, func);
    }
     ...
     */
    get promise() {
        return this.responses.length > 0? this.responses[0].promise:undefined;
    }
     ...
     */
    get resolve() {
        return this.responses.length > 0? this.responses[0].resolve:undefined;
    }
     ...
     */
    get reject() {
        return this.responses.length > 0? this.responses[0].reject:undefined;
    }
